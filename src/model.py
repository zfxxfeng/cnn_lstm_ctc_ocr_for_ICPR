...
def conv_layer(bottom, params, training ):#inputs, layer_params[0], training
...
def rnn_layers(features, sequence_length, num_classes):#features, sequence_length, mjsynth.num_classes()
...
def ctc_loss_layer(rnn_logits, sequence_labels, sequence_length):
    ...
    loss = tf.nn.ctc_loss( sequence_labels, rnn_logits, sequence_length,ignore_longer_outputs_than_inputs=True,
                           time_major=True )
